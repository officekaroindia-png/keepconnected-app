...
export const updateAnnouncement = (id, body) => api.patch(`/announcements/${id}`, { body }).then((r) => r.data.data);
...
export const resolveMapLink = (url) => api.get(`/resolve-map-link?url=${encodeURIComponent(url)}`).then((r) => r.data);
